...
dictionary.lookupWords = function(str) {
	...
	for (let i = 1; i < str.length + 1; i++) {
		...
		if (['니','며','느','라','을','은','으','지','는','게','네','잖','쇼','죠','고','듯'].includes(str.charAt(i-1)) || ['거나','거든','도록'].includes(str.substring(i-1,i+1)) || (GreedyWordRecognition_Enabled && ['기','십','았','었','이','던','되'].includes(str.charAt(i-1))) ){
